    ...
    <section style={{ background: "#fff", padding: "88px 48px" }}>
      <div style={{ maxWidth: 1200, margin: "0 auto", display: "grid", gridTemplateColumns: "1fr 1fr", gap: 80, alignItems: "center" }}>
        <div>
          ...
          <p style={{ fontSize: 16, fontWeight: 300, lineHeight: 1.75, color: "#5A6472", marginBottom: 32 }}>
            Alle våre leger er godkjente spesialister med bred erfaring fra både offentlig og privat sektor.
          </p>
        </div>
        <div style={{ background: "#F4F6F8", borderRadius: 4, height: 380, display: "flex", alignItems: "center", justifyContent: "center", border: "1px solid #E8ECF0" }}>

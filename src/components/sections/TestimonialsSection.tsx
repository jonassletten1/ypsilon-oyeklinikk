    ...
    <section style={{ background: "#F4F6F8", padding: "88px 48px" }}>
      <div style={{ maxWidth: 1200, margin: "0 auto" }}>
        <div style={{ textAlign: "center", marginBottom: 56 }}>
          <div style={{ fontSize: 10, fontWeight: 500, letterSpacing: "0.18em", textTransform: "uppercase", color: "#40577C", marginBottom: 14 }}>PASIENTOPPLEVELSER</div>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 16 }}>
          {reviews.map(r => (
            <div key={r.name} style={{ background: "#fff", borderRadius: 4, padding: "28px 24px", boxShadow: "0 1px 3px rgba(45,47,74,0.06)" }}>
              <div style={{ color: "#40577C", fontSize: 14, marginBottom: 14, letterSpacing: 2 }}>{"★".repeat(r.rating)}</div>
